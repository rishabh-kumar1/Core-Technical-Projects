...
def worker_message_generator(mock_sendall, tmp_path):
    ...
    # map messages. For more, see:
    # https://github.com/eecs485staff/p4-mapreduce/issues/416
    for _ in utils.wait_for_map_messages_async(mock_sendall, num=3):
        yield None
    ...
    utils.wait_for_reduce_messages(mock_sendall)
